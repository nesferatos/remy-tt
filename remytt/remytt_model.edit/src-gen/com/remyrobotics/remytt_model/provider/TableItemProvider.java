...
/**
 * This is the item provider adapter for a {@link com.remyrobotics.remytt_model.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addThingsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Table_things_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Table_things_feature", "_UI_Table_type"),
						Remytt_modelPackage.Literals.TABLE__THINGS, true, false, true, null, null, null));
	}
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Remytt_modelPackage.Literals.TABLE__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Remytt_modelPackage.Literals.TABLE__THINGS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case Remytt_modelPackage.TABLE__NAME:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case Remytt_modelPackage.TABLE__THINGS:
