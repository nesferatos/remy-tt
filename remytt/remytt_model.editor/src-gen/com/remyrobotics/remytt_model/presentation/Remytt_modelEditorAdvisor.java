...
import com.remyrobotics.remytt_model.presentation.Remytt_modelEditorPlugin;
 ...
 * @generated
 */
public final class Remytt_modelEditorAdvisor extends WorkbenchAdvisor {
	/**
	 ...
	 * @generated
	 */
	private static final String[] FILE_EXTENSION_FILTERS = Remytt_modelEditor.FILE_EXTENSION_FILTERS
	...
	private static String getString(String key, Object s1) {
		return com.remyrobotics.remytt_model.presentation.Remytt_modelEditorPlugin.INSTANCE.getString(key,
				new Object[] { s1 });
	}
	...
	public static class Application implements IApplication {
		...
		public Object start(IApplicationContext context) throws Exception {
			WorkbenchAdvisor workbenchAdvisor = new Remytt_modelEditorAdvisor();
	...
	public static class Perspective implements IPerspectiveFactory {
		 ...
		 * @generated
		 */
		public static final String ID_PERSPECTIVE = "com.remyrobotics.remytt_model.presentation.Remytt_modelEditorAdvisorPerspective";
	...
	public static class CookAction extends WorkbenchWindowActionDelegate {

		@Override
		public void run(IAction action) {
			Remytt_modelEditor editor = (Remytt_modelEditor) PlatformUI.getWorkbench().getActiveWorkbenchWindow()
					.getActivePage().getActiveEditor();
			Kitchen kitchen = (Kitchen) editor.getEditingDomain().getResourceSet().getResources().get(0).getContents()
					.get(0);

			com.remyrobotics.remytt_model.RoboDemo roboDemo = new com.remyrobotics.remytt_model.RoboDemo();
			roboDemo.run(kitchen);
	...
	/**
	 * Open action for the objects from the Remytt_model model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Open URI action for the objects from the Remytt_model model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
